...
def faust_app_factory(*args: object, **kwargs: object) -> object:
    ...
    try:
        import faust  # noqa: PLC0415
    except ImportError as exc:
        raise ImportError(
            "faust_app_factory requires the optional 'faust-streaming' package "
            "— install with 'pip install faust-streaming' "
            "(NEW_PIP_DEPENDENCIES in system_engine/streaming/faust_bus.py "
            "flags this)."
        ) from exc
    return faust.App(*args, **kwargs)
