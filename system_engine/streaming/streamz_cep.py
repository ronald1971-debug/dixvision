...
def streamz_stream_factory(graph: StreamGraph) -> Any:
    ...
    """
    try:
        import streamz  # noqa: PLC0415
    except ImportError as exc:
        raise ImportError(
            "streamz_stream_factory requires the optional 'streamz' package "
            "— install with 'pip install streamz' "
            "(NEW_PIP_DEPENDENCIES in system_engine/streaming/streamz_cep.py "
            "flags this)."
        ) from exc
    return streamz.Stream()
