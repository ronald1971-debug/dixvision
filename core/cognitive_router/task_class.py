...
class TaskClass(StrEnum):
    ...
    # Dyon Chat — multi-step agent orchestration (spawn a sub-task,
    # drive a tool chain). The router specifically filters for
    # ``agent_orchestration`` here so non-agentic providers are excluded.
