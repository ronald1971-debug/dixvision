...
def enable_haystack_factory(**_kwargs: Any) -> None:
    ...
    try:
        import haystack  # noqa: F401, PLC0415
    except ImportError as exc:
        raise ImportError(
            "enable_haystack_factory requires the optional 'haystack-ai' package "
            "— install with 'pip install haystack-ai' "
            "(NEW_PIP_DEPENDENCIES in state/knowledge_store.py flags this)."
        ) from exc
