...
LiteLLMRouter` — direct LlamaIndex LLM SDK calls are forbidden by
    ...
    """
    try:
        import llama_index  # noqa: F401, PLC0415
    except ImportError as exc:
        raise ImportError(
            "enable_llamaindex_factory requires the optional 'llama-index' package "
            "— install with 'pip install llama-index' "
            "(NEW_PIP_DEPENDENCIES in state/knowledge_store_llamaindex.py "
            "flags this)."
        ) from exc
