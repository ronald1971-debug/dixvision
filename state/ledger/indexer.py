...
class LedgerIndexer:
    ...
    def __init__(self, per_key_capacity: int = DEFAULT_PER_KEY_CAPACITY) -> None:
        ...
        self._by_type: dict[str, deque[int]] = defaultdict(lambda: deque(maxlen=self._cap))
        self._by_source: dict[str, deque[int]] = defaultdict(lambda: deque(maxlen=self._cap))
