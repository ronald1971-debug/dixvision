...
def enable_rich_formatter_factory() -> Callable[..., None]:
    ...
    try:
        ...
        raise ImportError(
            "enable_rich_formatter_factory requires the optional 'rich' package "
            "— install with 'pip install rich' "
            "(NEW_PIP_DEPENDENCIES in tools/cli.py flags this)."
        ) from exc
...
def enable_typer_factory() -> Callable[..., CliResult]:
    ...
    try:
        ...
        raise ImportError(
            "enable_typer_factory requires the optional 'typer' package "
