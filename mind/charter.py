...
INDIRA_CHARTER = Charter(
    ...
    how=[
        "Route every live trade through mind.fast_execute \u2192 state.fast_risk_cache \u2192 execution.adapter_router \u2192 exchange (<5ms hot path).",  # noqa: E501
        "Select a strategy via mind.strategy_arbiter (shadow-vs-live promotion + alpha-decay auto-demote).",  # noqa: E501
        "Consume MarketTicks from mind.sources and normalized feedback from mind.knowledge.feedback_cleaner.",  # noqa: E501
        "Record every decision + outcome in state.ledger (MARKET stream) and state.episodic_memory.",  # noqa: E501
        "Respect the EXECUTION_CONSTRAINT_SET written by governance to the risk cache (read-only for INDIRA).",  # noqa: E501
    ],
    why=[
    ...
    accountability=[
        ...
        "MARKET/FILL",
        "MARKET/CANCEL",
        "MARKET/STRATEGY_SHADOW",
        "MARKET/STRATEGY_PROMOTED",
        "MARKET/ALPHA_DECAY",
        "MARKET/REJECT",
    ],
    tools=[
        "mind.fast_execute",
        "mind.strategy_arbiter",
        "mind.strategies",
        "mind.sources",
        "execution.adapter_router",
        "execution.algos",
        "state.fast_risk_cache (read-only)",
