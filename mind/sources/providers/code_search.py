...
_SPECS: tuple[CodeSearchSpec, ...] = (
    ...
    CodeSearchSpec(
        "codeberg_search", "https://codeberg.org/api/v1/repos/search", rps=0.5, weight=0.5
    ),
    CodeSearchSpec("sourcehut_search", "https://git.sr.ht/api/projects", rps=0.25, weight=0.4),
    CodeSearchSpec(
        "bitbucket_search", "https://api.bitbucket.org/2.0/repositories", rps=0.25, weight=0.4
    ),
    CodeSearchSpec("pypi_json", "https://pypi.org/pypi/", rps=1.0, weight=0.8),
    CodeSearchSpec("npm_registry", "https://registry.npmjs.org/-/v1/search", rps=1.0, weight=0.6),
    CodeSearchSpec("crates_io", "https://crates.io/api/v1/crates", rps=1.0, weight=0.7),
    CodeSearchSpec(
        "huggingface_models",
    ...
    CodeSearchSpec("papers_with_code", "https://paperswithcode.com/api/v1/", rps=0.2, weight=0.7),
    CodeSearchSpec(
        "kaggle_datasets",
        "https://www.kaggle.com/api/v1/datasets/list",
        key_env="KAGGLE_API_KEY",
        key_required=True,
        rps=0.2,
        weight=0.6,
    ),
...
_CODING_SEEDS: tuple[str, ...] = (
    "asyncio retry backoff",
    "sqlite wal best practice",
    "ast transformer",
...
__all__ = ["CODE_SEARCH_PROVIDERS", "DiscoveryCandidate", "score_candidate", "propose"]
