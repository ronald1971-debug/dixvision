        ...
        def train(  # pragma: no cover - exercised when elegantrl present
            ...
            *,
            ...
            try:
                ...
                from elegantrl.train.config import Arguments as ElegantConfig  # type: ignore[import-not-found]
            except ImportError:
                try:
                    # ElegantRL v3.x: elegantrl.Config
                    from elegantrl import Config as ElegantConfig  # type: ignore[import-not-found, no-redef]
                except ImportError:
