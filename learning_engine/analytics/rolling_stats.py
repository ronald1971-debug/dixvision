...
def enable_bottleneck_kernel_factory() -> Callable[[str], Callable[..., Any]]:
    ...
    try:
        ...
        raise ImportError(
            "enable_bottleneck_kernel_factory requires the optional 'bottleneck' package "
            "— install with 'pip install bottleneck' "
            "(NEW_PIP_DEPENDENCIES in learning_engine/analytics/rolling_stats.py flags this)."
        ) from exc
