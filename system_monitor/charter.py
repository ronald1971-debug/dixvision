...
DYON_CHARTER = Charter(
    ...
    how=[
        "Publish/consume SYSTEM_HAZARD events via system_monitor.hazard_bus"
        " (canonical; execution.hazard is a re-export shim).",
        "Precompile hazard\u2192action lookups (execution.interrupt.policy_cache, frozen dict, O(1) dispatch).",  # noqa: E501
        "Monitor heartbeats, feed silence, latency spikes, queue saturation, and ledger-hash consistency.",  # noqa: E501
        "Orchestrate AI coding proposals through system_monitor.coder \u2192 windows.updater (canary \u2192 sandbox \u2192 rollback \u2192 version_controller).",  # noqa: E501
    ...
    why=[
        ...
        "Manifest \u00a714 \u2014 updater: canary \u2192 sandbox \u2192 rollback \u2192 version_controller.",  # noqa: E501
    ...
    not_do=[
        ...
        "NEVER install a patch that touches mind/ or execution/adapters/ without governance approval.",  # noqa: E501
    ...
    accountability=[
        ...
        "SYSTEM/HEARTBEAT",
        "SYSTEM/LATENCY",
        "SYSTEM/PATCH_PROPOSED",
        "SYSTEM/PATCH_APPROVED",
        "SYSTEM/PATCH_APPLIED",
        "SYSTEM/PATCH_ROLLED_BACK",
        "SYSTEM/ADAPTER_ADDED",
        "SYSTEM/SOURCE_ADDED",
        "SYSTEM/DEAD_MAN_TRIPPED",
    ],
    tools=[
        "system_monitor.hazard_bus",
        "system_monitor.dyon_engine",
        "system_monitor.coder",
        "system_monitor.dead_man_switch",
        "execution.interrupt.policy_cache",
        "windows.updater",
        "state.ledger (SYSTEM stream)",
        "mind.sources.providers (onboarding)",
    ],
)
