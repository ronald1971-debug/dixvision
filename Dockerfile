...
#
# DEFAULT ENTRYPOINT: cockpit (lightweight pairing + worker surface).
# For the FULL trading system (all 6 engines, operator dashboard,
# governance FSM, execution gate), override the entrypoint:
#
#   docker run --rm -p 8080:8080 -v dix-data:/data dix-vision:42.2 \
#       python start.py
#
