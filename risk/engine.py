...
def compute_var_es(returns: Sequence[float], *, horizon_days: float = 1.0) -> RiskSnapshot:
...
def rolling_regime_label(
    returns: Sequence[float], fast_window: int = 10, slow_window: int = 40
) -> str:
...
__all__ = ["RiskSnapshot", "compute_var_es", "position_sizing", "rolling_regime_label"]
