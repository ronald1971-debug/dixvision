...
def enable_cachetools_response_factory(
    *,
    ...
    try:
        ...
        raise ImportError(
            "enable_cachetools_response_factory requires the optional 'cachetools' package "
            "— install with 'pip install cachetools' "
            "(NEW_PIP_DEPENDENCIES in intelligence_engine/cognitive/_response_cache.py flags this)."
        ) from exc
