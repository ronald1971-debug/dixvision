...
def enable_trading_agents_factory() -> None:
    ...
    try:
        import tradingagents  # type: ignore[import-not-found]  # noqa: F401
    except ImportError as exc:
        raise ImportError(
            "enable_trading_agents_factory requires the optional "
            "'tradingagents' package — install with "
            "'pip install tradingagents' "
            "(NEW_PIP_DEPENDENCIES in "
            "intelligence_engine/agents/trading_agents_bridge.py flags this)."
        ) from exc
